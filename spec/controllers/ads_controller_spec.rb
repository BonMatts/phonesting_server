  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ad as @ad" do
        ...
        post :create, {:ad => { "url" => "invalid value" }}, valid_session
        assigns(:ad).should be_a_new(Ad)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ad" do
        ...
        Ad.any_instance.should_receive(:update).with({ "url" => "MyString" })
        put :update, {:id => ad.to_param, :ad => { "url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ad as @ad" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ad.any_instance.stub(:save).and_return(false)
        put :update, {:id => ad.to_param, :ad => { "url" => "invalid value" }}, valid_session
        assigns(:ad).should eq(ad)
      end
