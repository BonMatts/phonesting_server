...
describe ScoresController do
  ...
  let(:valid_attributes) { { "points" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved score as @score" do
        ...
        post :create, {:score => { "points" => "invalid value" }}, valid_session
        assigns(:score).should be_a_new(Score)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested score" do
        ...
        Score.any_instance.should_receive(:update).with({ "points" => "MyString" })
        put :update, {:id => score.to_param, :score => { "points" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the score as @score" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Score.any_instance.stub(:save).and_return(false)
        put :update, {:id => score.to_param, :score => { "points" => "invalid value" }}, valid_session
        assigns(:score).should eq(score)
      end
