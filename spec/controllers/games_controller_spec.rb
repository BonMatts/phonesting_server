...
describe GamesController do
  ...
  let(:valid_attributes) { { "start" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, {:game => { "start" => "invalid value" }}, valid_session
        assigns(:game).should be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update).with({ "start" => "MyString" })
        put :update, {:id => game.to_param, :game => { "start" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Game.any_instance.stub(:save).and_return(false)
        put :update, {:id => game.to_param, :game => { "start" => "invalid value" }}, valid_session
        assigns(:game).should eq(game)
      end
